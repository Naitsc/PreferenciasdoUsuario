package com.naitsc.preferenciasdousuario
...
import com.naitsc.preferenciasdousuario.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun snackbar(view: View) {
        ...
        val snackbar =
            Snackbar.make(view, "Cor de fundo alterado com sucesso!", Snackbar.LENGTH_INDEFINITE)
